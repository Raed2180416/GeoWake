/// eta_engine.dart: Source file from lib/lib/services/eta/eta_engine.dart
/// 
...
class EtaEngine {
  ...
  EtaResult update({
    ...
    /// decisions: [Brief description of what this function does]
    /// 
    /// **Parameters**: [Describe parameters if any]
    /// **Returns**: [Describe return value]
    ...
    if (_recentEtas.length >= 2) {
      /// reduce: [Brief description of what this function does]
      /// 
      /// **Parameters**: [Describe parameters if any]
      /// **Returns**: [Describe return value]
